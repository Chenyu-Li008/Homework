...
3、以2018年的增速计算为例，在EXCEL里输入公式=(B2-B3)/B3*100%，得出增速  
4、得到增速，保留四位有效数字。
同理，得到其他六年的增速  
5、由于到了2015年，基准年份变动为2015年，使用2015年的不变价计算2016年的增速，得到的结果会骤然增大。因此2016年的季度GDP增速计算方式为 （2016年GDP不变价-2015年GDP现价）/2015年GDP现价
